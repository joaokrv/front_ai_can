...
// Schema de validação do formulário de Onboarding com coerções numéricas
...
export const OnboardingPage: React.FC = () => {
    ...
    const carregarPerfilExistente = async () => {
      try {
        ...
        if (dados && dados.idade !== null) {
          // Mapeia as restrições vindas do backend ('lactose', 'gluten') para as chaves correspondentes da UI ('sem_lactose', 'sem_gluten')
        ...
        // Silencia erro se for a primeira vez e o usuário ainda não tiver perfil
      }
    };
  ...
  const onSubmit = async (data: OnboardingFormValues) => {
    ...
    try {
      ...
      // Prossegue para a etapa 3 de geração do plano
    ...
    <div className={styles.container}>
      ...
      <div className={styles.contextSidebar}>
        ...
        <div className={styles.sidebarContent}>
          <h2 className={styles.sidebarTitle}>Personalize sua experiência</h2>
          <p className={styles.sidebarDesc}>
            Para criarmos planos de treino e nutrição que realmente funcionem, precisamos conhecer seu perfil e suas limitações físicas.
          </p>
        </div>

        <div className={styles.supportText}>
          Seus dados estão protegidos sob nossa política de privacidade de dados de saúde.
        </div>
      </div>
      ...
      <div className={styles.formArea}>
        <div className={styles.formWrapper}>
          <Stepper currentStep={2} steps={['Conta', 'Preferências', 'Geração IA']} />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
            ...
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                ...
                <p className={styles.sectionDesc}>Precisamos desses dados para calcular taxas de metabolismo e volumes de treino adequados.</p>
              </div>
            ...
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                ...
                <p className={styles.sectionDesc}>Iremos orientar a inteligência artificial para focar as calorias e os exercícios nesta meta.</p>
              </div>
            ...
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                ...
                <p className={styles.sectionDesc}>Iremos personalizar as sugestões pré e pós-treino com base em suas intolerâncias e cuidados físicos.</p>
              </div>
              ...
              <div className={styles.textareaWrapper}>
                ...
                <textarea
                  ...
                  placeholder="Ex: Hérnia de disco L4-L5, dor articular no joelho esquerdo. Evitar saltos e sobrecarga axial..."
